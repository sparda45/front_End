    ...
    >
        ...
        <div class="lg:w-full w-[55px] mx-auto">
            ...
            <div class="lg:block hidden text-[11px] text-gray-500">
                <div class="pt-4 px-2">About Newsroom Digtok Shop Contact Careers ByteDance</div>
                <div class="pt-4 px-2">Digtok for Good Advertise Developers Transparency Digtok Rewards Digtok Browse Digtok Embeds</div>
                <div class="pt-4 px-2">Help Safety Terms Privacy Creator Portal Community Guidelines</div>
                <div class="pt-4 px-2">© 2023 Digtok</div>
            </div>
